"""FastAPI application (Ear2Finger API + optional bundled SPA)."""
...
from ear2finger import __version__
from ear2finger.database import init_db
from ear2finger.routers import (
    auth,
    dictation,
    health,
    learning_progress,
...
# Bundled Vite build: package_data copies into web/dist
_FRONTEND_DIST = Path(__file__).resolve().parent / "web" / "dist"
